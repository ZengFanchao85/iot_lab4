...
thingId           = -1
thingName         = ''
defaultPolicyName = 'GreengrassCorePolicy'
...
for i in range(thingCount):
    thingName = 'test_' + str(i)

    thingDirPath    = certsDirPath + "/" + thingName
    certificatePath = thingDirPath + "/" + "certificate.pem.crt"
    privateKeyPath  = thingDirPath + "/" + "private.pem.key"
    publicKeyPath   = thingDirPath + "/" + "public.pem.key"
    create_thing()